...
class Ui_AlimentacionScreen(object):
    def setupUi(self, AlimentacionScreen):
        AlimentacionScreen.setObjectName("AlimentacionScreen")
        AlimentacionScreen.resize(568, 400)
        AlimentacionScreen.setMinimumSize(QtCore.QSize(568, 400))
        AlimentacionScreen.setMaximumSize(QtCore.QSize(568, 400))
        AlimentacionScreen.setStyleSheet("border: 2px solid #3498db;\n"
"border-radius: 10px;\n"
"\n"
"background-color: #eaf2ff;")
        self.centralwidget = QtWidgets.QWidget(AlimentacionScreen)
...
"text-align: center;")
        ...
        self.btn_editar.setGeometry(QtCore.QRect(390, 20, 60, 60))
...
"}")
        ...
        self.btn_agregar.setGeometry(QtCore.QRect(320, 20, 60, 60))
...
"}")
        ...
        self.btn_borrar.setGeometry(QtCore.QRect(460, 20, 60, 60))
...
"")
        ...
        AlimentacionScreen.setCentralWidget(self.centralwidget)

        self.retranslateUi(AlimentacionScreen)
        QtCore.QMetaObject.connectSlotsByName(AlimentacionScreen)

    def retranslateUi(self, AlimentacionScreen):
        _translate = QtCore.QCoreApplication.translate
        AlimentacionScreen.setWindowTitle(_translate("AlimentacionScreen", "MainWindow"))
        self.groupBox.setTitle(_translate("AlimentacionScreen", "Alimentacion"))
        self.label.setText(_translate("AlimentacionScreen", "Alimentacion"))
        self.groupBox_2.setTitle(_translate("AlimentacionScreen", "Mostrar"))
