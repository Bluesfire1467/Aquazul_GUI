...
class Ui_CorreoScreen(object):
    def setupUi(self, CorreoScreen):
        CorreoScreen.setObjectName("CorreoScreen")
        CorreoScreen.resize(568, 400)
        CorreoScreen.setMinimumSize(QtCore.QSize(568, 400))
        CorreoScreen.setMaximumSize(QtCore.QSize(568, 400))
        CorreoScreen.setStyleSheet("border: 2px solid #3498db;\n"
"border-radius: 10px;\n"
"\n"
"background-color: #eaf2ff;")
        self.centralwidget = QtWidgets.QWidget(CorreoScreen)
...
"text-align: center;")
        ...
        self.btn_borrar.setGeometry(QtCore.QRect(450, 20, 60, 60))
...
"}")
        ...
        self.btn_editar.setGeometry(QtCore.QRect(380, 20, 60, 60))
...
"}")
        ...
        self.btn_agregar.setGeometry(QtCore.QRect(310, 20, 60, 60))
...
"")
        ...
        self.table_correo = QtWidgets.QTableWidget(self.groupBox_2)
        self.table_correo.setObjectName("table_correo")
        self.table_correo.setColumnCount(0)
        self.table_correo.setRowCount(0)
        self.horizontalLayout.addWidget(self.table_correo)
        self.verticalLayout.addWidget(self.groupBox_2)
        CorreoScreen.setCentralWidget(self.centralwidget)

        self.retranslateUi(CorreoScreen)
        QtCore.QMetaObject.connectSlotsByName(CorreoScreen)

    def retranslateUi(self, CorreoScreen):
        _translate = QtCore.QCoreApplication.translate
        CorreoScreen.setWindowTitle(_translate("CorreoScreen", "Correo"))
        self.groupBox.setTitle(_translate("CorreoScreen", "Correo"))
        self.label.setText(_translate("CorreoScreen", "Correo"))
        self.groupBox_2.setTitle(_translate("CorreoScreen", "Mostrar"))
