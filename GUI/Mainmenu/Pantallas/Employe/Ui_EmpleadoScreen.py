...
"text-align: center;")
        ...
        self.line_direccion.setGeometry(QtCore.QRect(390, 70, 131, 20))
        self.line_direccion.setObjectName("line_direccion")
        self.line_correo = QtWidgets.QLineEdit(self.groupBox)
        self.line_correo.setGeometry(QtCore.QRect(390, 100, 131, 20))
...
"}")
        ...
        self.comboBox_sucursal.setGeometry(QtCore.QRect(390, 40, 131, 22))
        self.comboBox_sucursal.setObjectName("comboBox_sucursal")
        self.verticalLayout.addWidget(self.groupBox)
        self.table_empleado = QtWidgets.QTableWidget(self.centralwidget)
        self.table_empleado.setMinimumSize(QtCore.QSize(550, 0))
        self.table_empleado.setMaximumSize(QtCore.QSize(550, 16777215))
        self.table_empleado.setObjectName("table_empleado")
        self.table_empleado.setColumnCount(0)
        self.table_empleado.setRowCount(0)
        self.verticalLayout.addWidget(self.table_empleado)
