...
# Form implementation generated from reading ui file 'Peligro.ui'
#
...
class Ui_PeligroScreen(object):
    def setupUi(self, PeligroScreen):
        PeligroScreen.setObjectName("PeligroScreen")
        PeligroScreen.resize(568, 400)
        PeligroScreen.setMinimumSize(QtCore.QSize(568, 400))
        PeligroScreen.setMaximumSize(QtCore.QSize(568, 400))
        PeligroScreen.setStyleSheet("border: 2px solid #3498db;\n"
"border-radius: 10px;\n"
"\n"
"background-color: #eaf2ff;")
        self.centralwidget = QtWidgets.QWidget(PeligroScreen)
...
"text-align: center;")
        ...
        self.line_peligro.setGeometry(QtCore.QRect(150, 40, 121, 20))
...
"")
        ...
        self.table_peligro = QtWidgets.QTableWidget(self.groupBox_2)
        self.table_peligro.setObjectName("table_peligro")
        self.table_peligro.setColumnCount(0)
        self.table_peligro.setRowCount(0)
        self.horizontalLayout.addWidget(self.table_peligro)
        self.verticalLayout.addWidget(self.groupBox_2)
        PeligroScreen.setCentralWidget(self.centralwidget)

        self.retranslateUi(PeligroScreen)
        QtCore.QMetaObject.connectSlotsByName(PeligroScreen)

    def retranslateUi(self, PeligroScreen):
        _translate = QtCore.QCoreApplication.translate
        PeligroScreen.setWindowTitle(_translate("PeligroScreen", "Peligro"))
        self.groupBox.setTitle(_translate("PeligroScreen", "Peligro"))
        self.label.setText(_translate("PeligroScreen", "Peligro"))
        self.groupBox_2.setTitle(_translate("PeligroScreen", "Mostrar"))
